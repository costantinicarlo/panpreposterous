...
- ../check-mixed-density-wide-table.sh: regression harness for bounded content-aware wide-table column allocation
...
- ../mixed-density-wide-table.md: fixture validating wider allocations for dense columns and narrower allocations for sparse columns
