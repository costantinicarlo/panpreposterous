...
Text before the wide-table cell overflow regression fixture.

::: {#tbl:wide-table-cell-overflow .fullwidth placement="tb"}
| Short | Dense narrative content | Notes |
| --- | --- | --- |
...
Text after the wide-table cell overflow regression fixture.
